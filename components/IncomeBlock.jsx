import { FlatList, StyleSheet, Text, View, ListRenderItem, TouchableOpacity } from 'react-native'
        ...
        <View style={{backgroundColor: Colors.grey, padding: 20, borderRadius: 20, marginRight: 15, width: 150, gap: 10}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <View style={{borderColor: '#666', borderWidth: 1, borderRadius: 50, padding: 5, alignSelf: 'flex-start'}}>
                    ...
                    {/* We will use the icon variable and loop through the icons for the appropriate application. */}
                    {icon}
                </View>
            ...
            <Text style={{color: Colors.white, fontSize: 18, fontWeight: '600'}}>${amount[0]}.<Text style={{fontSize: 12, fontWeight: '400'}}>{amount[1]}</Text></Text>
        </View>
    )
  }
